package com.ghca.vm.autosdk;

import com.ghca.vm.autosdk.auth.VapiAuthenticationHelper;
...
public class SessionHelper {
    ...
    public void login(String server,String sessionid) throws Exception {
        this.vapiAuthHelper = new VapiAuthenticationHelper();

        HttpConfiguration httpConfig = buildHttpConfiguration();
        this.sessionStubConfig =
                vapiAuthHelper.loginBySessionId(
                        server, sessionid, httpConfig);
